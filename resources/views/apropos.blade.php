...
@section('contenu')
        <div class="section">
            <h3><a class="ancre" id="auteur">#</a>Les auteurs de ce site</h3>
        ...
        <div class="section">
            <h3><a class="ancre" id="contributeur">#</a>Les contributeurs</h3>
        ...
        <div class="section">
            <h3><a class="ancre" id="ancien">#</a>Les anciens</h3>
