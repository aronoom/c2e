...
Route::get('user/bienvenue', 'UserController@bienvenue')->name('user.bienvenue');
Route::post('user', 'UserController@store')->name('user.store')->middleware('guest_user');
Route::get('user/create', 'UserController@create')->name('user.create')->middleware('guest_user');
